...
export function trsToMat4(t, out = mat4Identity()) {
...
export function mat4Multiply(a, b, out = mat4Identity()) {
...
export function mat4Invert(m, out = mat4Identity()) {
    ...
    const t1 = m[12], t2 = m[13], t3 = m[14];
    const det = n11 * (n22 * n33 - n32 * n23) -
        n21 * (n12 * n33 - n32 * n13) +
        n31 * (n12 * n23 - n22 * n13);
...
export function mat4ToTrs(m, out) {
    out.x = m[12];
    out.y = m[13];
    out.z = m[14];
...
export function copyTrs(from, to) {
    to.x = from.x;
    to.y = from.y;
    to.z = from.z;
    to.rx = from.rx;
 ...
 */
export function formatHierarchyTree(roots, childrenOf, label) {
    const lines = ["World Hierarchy", "────────────────", ""];
    function walk(entity, prefix, isLast) {
...
function walkChild(entity, prefix, isLast, childrenOf, label, lines) {
...
//# sourceMappingURL=math_trs.js.map