 ...
 */
export class InProcessAbiExecutor {
    resolve;
    validateAccess;
    bindCache = new Map();
    constructor(options) {
        ...
        try {
            ...
            if (mod.abiVersion !== ABI_VERSION && mod.abiVersion !== undefined) {
                ...
                if (mod.abiVersion !== invocation.abiVersion) {
                    throw new AbiError("unsupported_version", `System "${mod.name}" abiVersion ${mod.abiVersion} incompatible with invocation ${invocation.abiVersion}`, invocation.system.name);
                }
            }
            ...
            const execMs = (typeof performance !== "undefined" ? performance.now() : Date.now()) -
                t0;
...
//# sourceMappingURL=in_process.js.map